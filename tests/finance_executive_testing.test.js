...
test.use({ storageState: 'states/.auth/financeExecutive.json' });
...
test("New Initial Request Form, Valid Test", async ({ page }) => {
  ...
  await page.getByLabel('Title').fill('Request Form from Finance Executive');
  ...
  await page.getByLabel('Reason of Purchase').fill('This is entered by Finance Executive');
