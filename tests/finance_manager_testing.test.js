...
test.use({ storageState: 'states/.auth/financeManager.json' });
...
test('View IRF Summary, Valid Test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Filter By Requisitor').fill('finance manager');
  await page.getByRole('button', { name: '󰍉 filter' }).click();
  await expect(page.getByRole('table')).toContainText('finance manager');
  ...
  await page.getByLabel('IRF No.').click();
  await page.getByPlaceholder('Filter By IRF No.').press('CapsLock');
  await page.getByPlaceholder('Filter By IRF No.').fill('KIRF/FNA/2024/00035');
  await page.getByPlaceholder('Filter By IRF No.').press('CapsLock');
  await page.getByRole('button', { name: '󰍉 filter' }).click();
  await expect(page.getByRole('table')).toContainText('KIRF/FNA/2024/00035');
  await page.locator('div:nth-child(4) > .pl-1 > .v-btn').click();
  await page.getByRole('button', { name: 'Reset' }).click();
  await expect(page.getByRole('main')).toContainText('IRF No.');
  ...
  await page.getByPlaceholder('Filter By IRF Title').fill('Request Form from Finance Manager');
  await page.getByRole('button', { name: '󰍉 filter' }).click();
  await expect(page.getByRole('table')).toContainText('Request Form from Finance Manager');
  await page.locator('div:nth-child(5) > .pl-1 > .v-btn').click();
...
test('View Quotation Summary, Valid Test', async ({ page }) => {
  await page.goto(process.env.BASE_URL);
  await page.getByRole('button', { name: 'Badge Quotation' }).click();
  ...
  await page.getByPlaceholder('Filter By IRF Title').fill('T');
  await page.getByPlaceholder('Filter By IRF Title').press('CapsLock');
  await page.getByPlaceholder('Filter By IRF Title').fill('Test ');
  await page.getByPlaceholder('Filter By IRF Title').press('CapsLock');
  await page.getByPlaceholder('Filter By IRF Title').fill('Test A');
  await page.getByPlaceholder('Filter By IRF Title').press('CapsLock');
  await page.getByPlaceholder('Filter By IRF Title').fill('Test Add ');
  await page.getByPlaceholder('Filter By IRF Title').press('CapsLock');
  await page.getByPlaceholder('Filter By IRF Title').fill('Test Add Q');
  await page.getByPlaceholder('Filter By IRF Title').press('CapsLock');
